...
export type MiddsStakeholderEditableStakeholderField = {
	type: "IpiBase";
	value?: AllfeatSupportIpiIpiNameNumber | undefined;
} | {
	type: "FirstName";
...
export interface ChainStorage<Rv extends RpcVersion> extends GenericChainStorage<Rv> {
	...
	system: {
		 ...
		 **/
		eventTopics: GenericStorageQuery<Rv, (arg: H256) => Array<[
			number,
			number
		]>, H256>;
		/**
	...
	babe: {
		 ...
		 **/
		authorities: GenericStorageQuery<Rv, () => Array<[
			SpConsensusBabeAppPublic,
			bigint
		]>>;
		/**
		 ...
		 * @param {Callback<Array<[SpConsensusBabeAppPublic, bigint]>> =} callback
		 **/
		nextAuthorities: GenericStorageQuery<Rv, () => Array<[
			SpConsensusBabeAppPublic,
			bigint
		]>>;
		/**
		 ...
		 **/
		epochStart: GenericStorageQuery<Rv, () => [
			number,
			number
		]>;
		/**
		 ...
		 **/
		skippedEpochs: GenericStorageQuery<Rv, () => Array<[
			bigint,
			number
		]>>;
		/**
	...
	session: {
		 ...
		 **/
		queuedKeys: GenericStorageQuery<Rv, () => Array<[
			AccountId32,
		 ...
		 **/
		nextKeys: GenericStorageQuery<Rv, (arg: AccountId32Like) => MelodieRuntimePalletsSessionSessionKeys | undefined, AccountId32>;
		/**
		 ...
		 * @param {Callback<AccountId32 | undefined> =} callback
		 **/
		keyOwner: GenericStorageQuery<Rv, (arg: [
	...
	grandpa: {
		 ...
		 **/
		stalled: GenericStorageQuery<Rv, () => [
			number,
			number
		] | undefined>;
		/**
	...
	identity: {
		 ...
		 **/
		superOf: GenericStorageQuery<Rv, (arg: AccountId32Like) => [
			AccountId32,
			Data
		 ...
		 **/
		subsOf: GenericStorageQuery<Rv, (arg: AccountId32Like) => [
			bigint,
			Array<AccountId32>
		], AccountId32>;
		/**
	...
	scheduler: {
		 ...
		 **/
		retries: GenericStorageQuery<Rv, (arg: [
			number,
			number
		]) => PalletSchedulerRetryConfig | undefined, [
			number,
			number
		]>;
		/**
		 ...
		 * @param {Callback<[number, number] | undefined> =} callback
		 **/
		lookup: GenericStorageQuery<Rv, (arg: FixedBytes<32>) => [
			number,
			number
		] | undefined, FixedBytes<32>>;
		/**
		 * Generic pallet storage query
		 **/
		[storage: string]: GenericStorageQuery<Rv>;
	...
	proxy: {
		 ...
		 **/
		proxies: GenericStorageQuery<Rv, (arg: AccountId32Like) => [
			Array<PalletProxyProxyDefinition>,
			bigint
		], AccountId32>;
		/**
		 ...
		 **/
		announcements: GenericStorageQuery<Rv, (arg: AccountId32Like) => [
			Array<PalletProxyAnnouncement>,
			bigint
		], AccountId32>;
		/**
		 * Generic pallet storage query
	...
	multisig: {
		 ...
		 **/
		multisigs: GenericStorageQuery<Rv, (arg: [
			AccountId32Like,
			FixedBytes<32>
...
export interface ChainEvents<Rv extends RpcVersion> extends GenericChainEvents<Rv> {
	...
	system: {
		 ...
		 * A [`Task`] has started executing
		 **/
		TaskStarted: GenericPalletEvent<Rv, "System", "TaskStarted", {
			task: MelodieRuntimeRuntimeTask;
		}>;
		/**
		 * A [`Task`] has finished executing.
		 **/
		TaskCompleted: GenericPalletEvent<Rv, "System", "TaskCompleted", {
			task: MelodieRuntimeRuntimeTask;
		}>;
		/**
		 * A [`Task`] failed during execution.
		 **/
		TaskFailed: GenericPalletEvent<Rv, "System", "TaskFailed", {
			task: MelodieRuntimeRuntimeTask;
			err: DispatchError;
		}>;
		/**
	...
	validatorSet: {
		 ...
		 * New validator addition initiated. Effective in ~2 sessions.
		 **/
		ValidatorAdditionInitiated: GenericPalletEvent<Rv, "ValidatorSet", "ValidatorAdditionInitiated", AccountId32>;
		/**
		 * Validator removal initiated. Effective in ~2 sessions.
		 **/
		ValidatorRemovalInitiated: GenericPalletEvent<Rv, "ValidatorSet", "ValidatorRemovalInitiated", AccountId32>;
		/**
		 * Generic pallet event
		 **/
		[prop: string]: GenericPalletEvent<Rv>;
	 ...
	 **/
	stakeholders: {
		MiddsRegistered: GenericPalletEvent<Rv, "Stakeholders", "MIDDSRegistered", {
			provider: AccountId32;
			hashId: H256;
			dataColateral: bigint;
		}>;
		MiddsUpdated: GenericPalletEvent<Rv, "Stakeholders", "MIDDSUpdated", {
			hashId: H256;
		}>;
		MiddsUnregistered: GenericPalletEvent<Rv, "Stakeholders", "MIDDSUnregistered", {
			hashId: H256;
		}>;
		/**
		 * Generic pallet event
	 ...
	 **/
	musicalWorks: {
		MiddsRegistered: GenericPalletEvent<Rv, "MusicalWorks", "MIDDSRegistered", {
			provider: AccountId32;
			hashId: H256;
			dataColateral: bigint;
		}>;
		MiddsUpdated: GenericPalletEvent<Rv, "MusicalWorks", "MIDDSUpdated", {
			hashId: H256;
		}>;
		MiddsUnregistered: GenericPalletEvent<Rv, "MusicalWorks", "MIDDSUnregistered", {
			hashId: H256;
		}>;
		/**
		 * Generic pallet event
...
export type ChainSubmittableExtrinsic<Rv extends RpcVersion, T extends IRuntimeTxCall = MelodieRuntimeRuntimeCallLike> = Extrinsic<MultiAddressLike, T, SpRuntimeMultiSignature, any[]> & (Rv extends RpcV2 ? ISubmittableExtrinsic<ISubmittableResult<FrameSystemEventRecord>> : ISubmittableExtrinsicLegacy<ISubmittableResult<FrameSystemEventRecord>>);
...
export interface ChainTx<Rv extends RpcVersion> extends GenericChainTx<Rv, TxCall<Rv>> {
	...
	system: {
		 ...
		 **/
		setStorage: GenericTxCall<Rv, (items: Array<[
			BytesLike,
			BytesLike
		 ...
		 **/
		doTask: GenericTxCall<Rv, (task: MelodieRuntimeRuntimeTask) => ChainSubmittableExtrinsic<Rv, {
			pallet: "System";
			palletCall: {
				name: "DoTask";
				params: {
	...
	validatorSet: {
		 ...
		 **/
		addValidator: GenericTxCall<Rv, (validatorId: AccountId32Like) => ChainSubmittableExtrinsic<Rv, {
			pallet: "ValidatorSet";
			palletCall: {
				name: "AddValidator";
				params: {
		 ...
		 * @param {AccountId32Like} validatorId
		 **/
		removeValidator: GenericTxCall<Rv, (validatorId: AccountId32Like) => ChainSubmittableExtrinsic<Rv, {
			pallet: "ValidatorSet";
			palletCall: {
				name: "RemoveValidator";
				params: {
	...
	session: {
		 ...
		 **/
		setKeys: GenericTxCall<Rv, (keys: MelodieRuntimePalletsSessionSessionKeys, proof: BytesLike) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Session";
			palletCall: {
				name: "SetKeys";
				params: {
	...
	identity: {
		 ...
		 **/
		setSubs: GenericTxCall<Rv, (subs: Array<[
			AccountId32Like,
			Data
		]>) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Identity";
	...
	scheduler: {
		 ...
		 * @param {MelodieRuntimeRuntimeCallLike} call
		 **/
		schedule: GenericTxCall<Rv, (when: number, maybePeriodic: [
			number,
			number
		] | undefined, priority: number, call: MelodieRuntimeRuntimeCallLike) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Scheduler";
			palletCall: {
				name: "Schedule";
				params: {
		 ...
		 * @param {MelodieRuntimeRuntimeCallLike} call
		 **/
		scheduleNamed: GenericTxCall<Rv, (id: FixedBytes<32>, when: number, maybePeriodic: [
			number,
			number
		] | undefined, priority: number, call: MelodieRuntimeRuntimeCallLike) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Scheduler";
		 ...
		 * @param {MelodieRuntimeRuntimeCallLike} call
		 **/
		scheduleAfter: GenericTxCall<Rv, (after: number, maybePeriodic: [
			number,
			number
		] | undefined, priority: number, call: MelodieRuntimeRuntimeCallLike) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Scheduler";
		 ...
		 * @param {MelodieRuntimeRuntimeCallLike} call
		 **/
		scheduleNamedAfter: GenericTxCall<Rv, (id: FixedBytes<32>, after: number, maybePeriodic: [
			number,
			number
		] | undefined, priority: number, call: MelodieRuntimeRuntimeCallLike) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Scheduler";
		 ...
		 * @param {number} period
		 **/
		setRetry: GenericTxCall<Rv, (task: [
			number,
			number
		], retries: number, period: number) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Scheduler";
			palletCall: {
				name: "SetRetry";
				params: {
		 ...
		 * @param {[number, number]} task
		 **/
		cancelRetry: GenericTxCall<Rv, (task: [
			number,
			number
		]) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Scheduler";
	...
	proxy: {
		 ...
		 * @param {MelodieRuntimeRuntimeCallLike} call
		 **/
		proxy: GenericTxCall<Rv, (real: MultiAddressLike, forceProxyType: MelodieRuntimePalletsProxyProxyType | undefined, call: MelodieRuntimeRuntimeCallLike) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Proxy";
			palletCall: {
				name: "Proxy";
				params: {
		 ...
		 * @param {number} delay
		 **/
		addProxy: GenericTxCall<Rv, (delegate: MultiAddressLike, proxyType: MelodieRuntimePalletsProxyProxyType, delay: number) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Proxy";
			palletCall: {
				name: "AddProxy";
				params: {
		 ...
		 * @param {number} delay
		 **/
		removeProxy: GenericTxCall<Rv, (delegate: MultiAddressLike, proxyType: MelodieRuntimePalletsProxyProxyType, delay: number) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Proxy";
			palletCall: {
				name: "RemoveProxy";
				params: {
		 ...
		 * @param {number} index
		 **/
		createPure: GenericTxCall<Rv, (proxyType: MelodieRuntimePalletsProxyProxyType, delay: number, index: number) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Proxy";
			palletCall: {
				name: "CreatePure";
				params: {
		 ...
		 **/
		killPure: GenericTxCall<Rv, (spawner: MultiAddressLike, proxyType: MelodieRuntimePalletsProxyProxyType, index: number, height: number, extIndex: number) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Proxy";
			palletCall: {
				name: "KillPure";
				params: {
		 ...
		 * @param {MelodieRuntimeRuntimeCallLike} call
		 **/
		proxyAnnounced: GenericTxCall<Rv, (delegate: MultiAddressLike, real: MultiAddressLike, forceProxyType: MelodieRuntimePalletsProxyProxyType | undefined, call: MelodieRuntimeRuntimeCallLike) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Proxy";
			palletCall: {
				name: "ProxyAnnounced";
				params: {
	...
	multisig: {
		 ...
		 * @param {MelodieRuntimeRuntimeCallLike} call
		 **/
		asMultiThreshold1: GenericTxCall<Rv, (otherSignatories: Array<AccountId32Like>, call: MelodieRuntimeRuntimeCallLike) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Multisig";
			palletCall: {
				name: "AsMultiThreshold1";
				params: {
		 ...
		 **/
		asMulti: GenericTxCall<Rv, (threshold: number, otherSignatories: Array<AccountId32Like>, maybeTimepoint: PalletMultisigTimepoint | undefined, call: MelodieRuntimeRuntimeCallLike, maxWeight: SpWeightsWeightV2Weight) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Multisig";
			palletCall: {
				name: "AsMulti";
				params: {
	...
	stakeholders: {
		 ...
		 **/
		register: GenericTxCall<Rv, (midds: MiddsStakeholderStakeholder) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Stakeholders";
			palletCall: {
				name: "Register";
				params: {
		 ...
		 **/
		updateField: GenericTxCall<Rv, (middsId: H256, fieldData: MiddsStakeholderEditableStakeholderField) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Stakeholders";
			palletCall: {
				name: "UpdateField";
				params: {
		 ...
		 * @param {H256} middsId
		 **/
		unregister: GenericTxCall<Rv, (middsId: H256) => ChainSubmittableExtrinsic<Rv, {
			pallet: "Stakeholders";
			palletCall: {
				name: "Unregister";
				params: {
...
export interface VersionedAllfeatApi<Rv extends RpcVersion> extends GenericSubstrateApi<Rv> {
